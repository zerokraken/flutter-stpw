...
class _NewRequestWidgetState extends State<NewRequestWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'NewRequest'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('NEW_REQUEST_NewRequest_ON_INIT_STATE');
      logFirebaseEvent('NewRequest_wait__delay');
              ...
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent(
                          'NEW_REQUEST_PAGE_Image_93d6clsi_ON_TAP');
                    ...
                    child: Image.asset(
                      'assets/images/file_document-upload-arrow-512.png',
                      width: 100.0,
                      height: 100.0,
                      fit: BoxFit.fill,
                    ),
